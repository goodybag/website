(function(exports){
  ...
  templates.partialRegistrationModal = [
    '<div class="popup-holder">'
  , '  <div class="login-box lightbox" id="complete-registration">'
  , '    <a href="#" class="close">close</a>'
  , '    <h3>Sign Up</h3>'
  , '    <a href="#" class="btn-facebook btn-facebook-partial">Connect with Facebook</a>'
  , '    <span class="or">or</span>'
  , '    <form action="#" class="sign-form" id="partial-registration-form">'
  , '      <fieldset>'
  , '        <div class="row">'
  , '          <label for="user-2">Username</label>'
  , '          <div class="text">'
  , '            <input type="text" id="user-2" class="field field-screenName" placeholder="Your Username">'
  , '          </div>'
  , '        </div>'
  , '        <div class="row">'
  , '          <label for="email">*Email (required)</label>'
  , '          <div class="text">'
  , '            <input type="text" id="email" class="field field-email" placeholder="me@example.com">'
  , '          </div>'
  , '        </div>'
  , '        <div class="row">'
  , '          <div class="item">'
  , '            <label for="pass-1">*Password (required)</label>'
  , '            <div class="text">'
  , '              <input type="password" id="pass-1" class="field field-password">'
  , '            </div>'
  , '          </div>'
  , '          <div class="item">'
  , '            <label for="pass-2">*Confirm Password</label>'
  , '            <div class="text">'
  , '              <input type="password" id="pass-2" class="field field-password">'
  , '            </div>'
  , '          </div>'
  , '        </div>'
  , '        <button><span>Complete Sign Up</span></button>'
  , '      </fieldset>'
  , '    </form>'
  , '  </div>'
  , '</div>'
