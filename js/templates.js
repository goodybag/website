(function(exports){
  ...
  , '          <div class="text">'
  , '            <input type="text" id="user" value="TheGoodybagOG">'
  , '          </div>'
  , '        </div>'
  , '        <div class="row">'
  ...
  , '    <img src="{{this.logoUrl}}/convert?w=114&h=114" alt="{{this.name}}">'
  ...
  , '  <img src="images/img-25.jpg" alt="{{name}}">'
  , '  <a href="#" class="link">Visit website</a>'
  , '</aside>'
  , '{{#each locations}}'
  , '<div class="contact-info">'
  , '  <address>{{this.street1}}{{#if this.street2}}, {{this.street2}}, {{this.city}}, {{this.state}} {{this.zip}}</address>'
