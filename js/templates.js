(function(exports){
  ...
  , '  </header>'
  , '  <img src="{{photoUrl}}/convert?w=240&h=240&fit=crop&cache=true" width="240" height="240" alt="{{description}}" onerror="this.src=\'images/img-\'+ (Math.floor(Math.random() * 10) + 1) + \'.jpg\'">'
